    ...
    return (
        <nav className={styles.tabBar}>
            <Link
                ...
                aria-current={pathname === '/en/account' ? 'page' : undefined}
            >
            ...
            <Link
                href="/en/account/menu"
                className={styles.tabItem}
                aria-current={pathname === '/en/account/menu' ? 'page' : undefined}
            >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <Link
                ...
                className={styles.tabItem}
                aria-current={pathname === '/en/account/profile' ? 'page' : undefined}
            >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
