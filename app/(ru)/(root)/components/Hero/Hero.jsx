            ...
            <div className={styles.heroContent}>
                <div className={styles.heroText}>
                    <div className={styles.badge}>
                        <span className={styles.badgeText}>Новая программа лояльности</span>
                    </div>
                    <h1>
                        UniFood<span className={styles.plus}>+</span>
                        <br />
                        <span className={styles.highlight}>Ваш путь к бонусам</span>
                    </h1>
                    <p className={styles.heroSubtitle}>
                        Присоединяйтесь к программе лояльности РТУ МИРЭА и получайте
                        эксклюзивные бонусы за каждую покупку
                    </p>
                    <div className={styles.ctaContainer}>
                        <a href="/registration" className={styles.primaryButton}>
                            <span>Начать сейчас</span>
                            <div className={styles.buttonGlow}></div>
                        </a>
                        <a href="/#more" className={styles.secondaryButton}>
